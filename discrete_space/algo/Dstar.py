...
class DStar:
    ...
    def on_press(self, pos, start=None):
        self.obs.append(pos)

        s_start = self.s_start if start is None else start
        s = s_start
        self.visited = set()
        self.count += 1
        ...
        self.path = self.extract_path(s_start, self.s_goal)
        return self.path, self.visited
    ...
    def get_neighbor(self, s):
        ...
        for u in motions:
            ...
            if self.x > s_next[0] >= 0 and self.y > s_next[1] >= 0:
