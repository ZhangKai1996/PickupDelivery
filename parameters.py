...
def parse_args():
    ...
    # Environment
    parser.add_argument("--num-agents", type=int, default=8, help="number of the drone")
    ...
    parser.add_argument("--num-buyers", type=int, default=8, help="number of buyers")
    parser.add_argument("--num-merchants", type=int, default=8, help="number of merchants")
